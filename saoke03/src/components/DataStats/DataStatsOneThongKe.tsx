...
import { ThongKeCommon } from "@/types/chat";
...
const dataStatsList = [
  ...
  },
  {
    ...
    color: "#18BFFF",
    title: "Tổng ngân hàng phân biệt được",
    value: "3.465",
    growthRate: -0.95,
  },
];

const DataStatsOneThongKe: React.FC<{ data?: ThongKeCommon }> = (props) => {
    ...
    return [
      {
        ...
        color: "#3FD97F",
        title: "Tổng giao dịch",
        value: numeral(props.data?.totalRecord ?? 0).format('0,000'),
        // growthRate: 0.43,
      },
      {
        icon: (
        ...
        color: "#FF9C55",
        title: "Tổng số tiền",
        value: new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND', maximumFractionDigits: 9 }).format(props.data?.totalCredit ?? 0),
        // growthRate: 4.35,
      },
      {
        icon: (
        ...
        color: "#8155FF",
        title: "Tổng mệnh giá",
        value: numeral(props.data?.allMoney ?? 0).format('0,000'),
        growthRate: 2.59,
      },
      {
        icon: (
        ...
        color: "#18BFFF",
        title: "Tổng ngân hàng phân biệt được",
        value: numeral(props.data?.allBank ?? 0).format('0,000'),
        growthRate: -0.95,
      },
    ]
  }, [props.data])
...
export default DataStatsOneThongKe;
